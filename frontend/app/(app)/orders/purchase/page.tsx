...
export default function PurchaseOrdersPage() {
  ...
  function openCreate() { setVendorId(''); setDueDate(''); setDiscount('0'); setItems([{ ...emptyLineItem }]); setModalOpen(true); }
  ...
  async function handleSave(e: React.FormEvent) {
    ...
    try {
      await api.post('/purchase-orders', {
        vendorId: Number(vendorId), dueDate: dueDate || undefined, discount: Number(discount),
